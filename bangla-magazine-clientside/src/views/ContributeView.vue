<template>
    <body class="text-gray-800 flex flex-col min-h-screen bg-gradient-to-r from-rose-50 to-emerald-50">
      ...
      <div class="relative flex-grow">
        ...
        <!-- Main Content -->
        <main class="container mx-auto p-6 relative flex-grow">
          <div class="space-y-6">
            <section class="bg-white rounded-lg shadow-md flex flex-col md:flex-row">
              ...
              <div class="md:w-2/5 md:pl-6 w-full p-6">
                ...
                <form action="#" method="POST" class="space-y-4">
                  ...
                  <div class="px-2">
                    ...
                    <textarea id="bio" name="bio" rows="2" class="w-full p-2 border border-gray-300 rounded-lg" required></textarea>
                  </div>
                  <div class="px-2">
                    <label for="file" class="block text-lg font-medium">Upload File</label>
                    <input type="file" id="file" name="file" class="w-full p-2 border border-gray-300 rounded-lg" required>
                  </div>
                  <div class="px-2">
  ...
  <style scoped>
  .scrollable {
    max-height: 900px; /* Adjust height based on your design */
