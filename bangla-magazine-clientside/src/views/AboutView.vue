<template>
    <body class="bg-gray-100 text-gray-800 flex flex-col min-h-screen">
      ...
      <main class="container mx-auto p-6 flex-grow">
        ...
        <section class="background-img relative bg-cover bg-center bg-no-repeat p-6 h-auto mb-8 flex items-center justify-center rounded-lg shadow-md">
            <div class="absolute inset-0 bg-gray-900 opacity-80 rounded-lg"></div>
            <div class="relative z-10 text-center text-white">
                <h2 class="text-3xl md:text-4xl font-bold mb-2 md:mb-4">Who We Are?</h2>
                <p class="text-lg md:text-xl max-w-3xl mx-auto">Our mission is to celebrate and sustain Bengali language
                    and culture globally, fostering connections among the diaspora and promoting cultural exchanges. We
                    aim to provide spaces for learning, cultural exchanges, and celebrations that acknowledge and promote
                    the diverse experiences of Bengalis worldwide.</p>
            </div>
        </section>

        <!-- Activities and Goals -->
        <section class="mb-8">
            <h2 class="text-3xl md:text-4xl font-bold mb-4 text-cyan-700 px-2 py-2 underline underline-offset-8 decoration-solid decoration-2">What We Do?</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <h3 class="text-xl md:text-2xl font-semibold mb-4 text-gray-800 mt-4 md:mt-0">Celebration of Bengali Culture Globally</h3>
                    <p class="text-lg md:text-xl text-gray-700 indent-8"><span class="md:text:3xl text-2xl text-amber-600 font-bold">W</span>e acknowledge the existence of Bengalis both outside and
                        inside their territorial borderlands, situating ourselves in the global distribution of Bengalis
                        as a linguo-cultural group.</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
                    <h3 class="text-xl md:text-2xl font-semibold mb-4 text-gray-800 ">Cultural Diaspora Experiences</h3>
                    <p class="text-lg md:text-xl text-gray-700 indent-8 "><span class="md:text:3xl text-2xl text-amber-600 font-bold">U</span>sing Bengali as a medium of instruction to teach foreign
                        languages and to interact with other languages through literary-cultural translations, we promote
                        symbiotic coexistence of different diasporic identities.</p>
                </div>
            </div>
        </section>
        ...
        <!-- Meet Our Team -->
        <section class="mb-8">
            <h2 class="text-3xl font-bold mb-4 text-cyan-700 px-2 py-2 mt-4 md:mt-0 underline underline-offset-8 decoration-solid decoration-2">Meet Our Team</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white p-4 rounded-lg shadow">
                    <img src="../assets/img/profile.jpg" alt="Team Member"
                        class="w-full h-48 object-cover rounded-t-lg">
                    <h3 class="text-2xl font-semibold mt-4">John Doe</h3>
                    <p class="text-gray-600">Editor-in-Chief</p>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <img src="../assets/img/profile_jane.jpg" alt="Team Member"
                        class="w-full h-48 object-cover rounded-t-lg">
                    <h3 class="text-2xl font-semibold mt-4">Jane Smith</h3>
                    <p class="text-gray-600">Managing Editor</p>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <img src="../assets/img/profile_jane.jpg" alt="Team Member"
                        class="w-full h-48 object-cover rounded-t-lg">
                    <h3 class="text-2xl font-semibold mt-4">Michael Brown</h3>
         ...
         <section class="mb-8">
            <div class="flex flex-col md:flex-row md:space-x-6">
                <h2 class="text-2xl font-bold mb-4 text-gray-800 py-2 px-2">Follow us on: </h2>
            ...
            <div class="flex flex-col md:flex-row md:space-x-6 mt-4">
                ...
                <p class="text-2xl mb-4 py-2"><a href="mailto:info@bangaliabhibasi.org"
                        class="text-cyan-600 hover:underline">info@bangaliabhibasi.org</a>.</p>
            </div>
        </section>
