<template>
  <section>
    <!-- Main Content -->
    <div
      class="container mx-auto md:mt-16 mt-8 mb-8 md:mb-16 p-4 md:p-6 min-h-screen"
    >
            ...
            >
              ...
              >
                <span class="font-cormorant font-bold">
                  Contribute to Porijaan - B.A.N.G.L.A.’s flagship digital
                  magazine</span
                >
              ...
              >
                Explore Our Submission Topics for the Magazine
              </button>
            </div>
            ...
            >
              ...
              <div class="px-2 relative flex-grow">
                <label for="submission-type" class="block font-medium"
                  >Submission Type<span class="text-red-500">*</span></label
                >
              ...
              <div class="px-2">
                <label for="tags" class="block font-medium"
                  >Hash tags<span class="text-red-500">*</span>
              ...
              <div class="px-2">
                <label for="description" class="block text-lg font-medium"
                  >Brief description of your work<span class="text-red-500"
                    >*</span
                  >
                  <span class="text-sm text-gray-500">
                    (Maximum 255 characters.)</span
