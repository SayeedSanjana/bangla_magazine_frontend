<template>
  <!-- Hero Banner Section -->
  <div
    class="relative w-screen h-[40vh] bg-center flex items-center justify-center text-center text-white"
  >
    <div
      class="absolute inset-0 bg-gradient-to-t from-purple-900 to-amber-500"
    ></div>
    <div class="relative z-10 px-4 sm:px-6 lg:px-8">
      <h1 class="text-4xl sm:text-5xl font-cormorant font-bold mb-4">
        Support Our Cultural Mission
      </h1>
      <p class="text-lg sm:text-xl text-white mb-6 max-w-2xl mx-auto">
    ...
    >
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h4 class="text-lg font-bold text-purple-700 mb-4">Why Donate?</h4>
          ...
          <div>
            ...
            <div class="text-sm text-gray-700 space-y-4">
              ...
              <p>
                <strong>Questions?</strong> {{ donationContent.info.contact }}
                <a
