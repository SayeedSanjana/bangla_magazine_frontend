    ...
    <div class="md:mx-auto flex-grow min-h-screen">
      ...
      <div class="bg-gradient-to-r from-amber-50 to-blue-50 pt-8">
        <div class="md:container md:mx-auto px-4 lg:px-32">
          <h2 class="text-4xl md:text-5xl text-gray-800 font-cormorant mb-8">
            Annual Theme
          </h2>
          <p class="text-amber-600 text-2xl text-justify pb-2">
          ...
          >
            ...
            <div class="w-full lg:w-2/5 md:pr-6 sticky lg:top-0 self-start">
              <div class="pt-6 flex justify-center">
                <img
                  src="../assets/svg/combined.svg"
                  alt="SVG Image 1"
                  class="w-full lg:max-w-[700px] max-w-[400px] h-auto object-cover"
                />
              </div>
            </div>

            <!-- Right Section: Accordion -->
            <div class="lg:w-3/5 w-full lg:overflow-y-auto">
              <div>
                ...
                <div class="flex flex-col my-6">
                  <div class="flex flex-wrap gap-4 lg:justify-center">
                    <div
                      v-for="(card, index) in accordionItems"
                      :key="index"
                      class="transform transition duration-300 ease-in-out hover:scale-105 bg-gradient-to-r to-gray-50 from-blue-50 shadow-md rounded-lg p-5 pt-0 m-4 flex flex-col w-full sm:w-3/4 md:w-2/3 lg:w-1/3 xl:w-1/4 relative"
                    >
                      <!-- Half Number -->
                      <div
                        class="absolute left-1/2 top-0 transform -translate-y-1/2 -translate-x-1/2"
                      >
                        <span
                          class="text-2xl font-bold font-cormorant text-midnight-sapphire"
                        >
                          {{ index + 1 }}.
                        </span>
                      </div>
                      ...
                      <h2
                        class="font-bold text-amber-600 text-lg underline underline-offset-2 font-cormorant mt-10"
                      >
                        {{ card.title }}
                      </h2>
                      <span class="text-gray-600 text-sm mt-4">{{
                        card.content
                      }}</span>
                    </div>
                  </div>
...
import image4 from "@/assets/img/photography.gif";
import image5 from "@/assets/img/health.gif";
import image6 from "@/assets/img/sports.gif";
    ...
    return {
      ...
      topics: [
        ...
        },
        {
          ...
          image: image2,
          description:
            "Submit essays, memoirs, and articles exploring real-world topics, personal reflections, or thought-provoking analyses.",
        },
        {
        ...
        },
        {
          ...
          image: image8,
          description:
            "Submit original scripts for drama or short films that bring fresh, engaging narratives to life.",
        },
        {
          name: "Poetry",
          image: image9,
